...
```
cd existing_repo
git remote add origin http://white.gitlab.com/freelancer/freelancer-strapi.git
git branch -M main
...
- [ ] [Set up project integrations](http://white.gitlab.com/freelancer/freelancer-strapi/-/settings/integrations)
