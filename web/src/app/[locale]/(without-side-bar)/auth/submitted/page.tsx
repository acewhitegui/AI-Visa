  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 p-10 rounded-lg shadow-md">
        <h2 className="mt-6 text-center text-3xl font-extrabold">Registration Successful</h2>
        <div className="text-center mt-6">
          ...
          <button
            ...
            className="mt-4 group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2"
          >
            Go to Login
          </button>
        </div>
