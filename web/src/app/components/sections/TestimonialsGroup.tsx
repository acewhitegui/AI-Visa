...
function Testimonial({text, authorName, picture}: Readonly<Testimonial>) {
  ...
  return (
    <div className="flex flex-col items-center mx-12 lg:mx-0 shadow py-8 rounded">
      ...
      <div className="relative text-center mx-2">
        ...
        <p className="px-6 py-1 text-2xl italic">{text}</p>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
          fill="currentColor"
...
export default function Testimonials({data}: TestimonialsProps) {
  return (
    <section className="">
      <div className="mx-auto py-4 space-y-2 text-center">
