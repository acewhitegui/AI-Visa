...
export function Steps({locale, productId, conversationId}: {
  ...
  const stepList = [
    {
      ...
      component: <Questions userToken={userToken} productId={productId} conversationId={conversationId}
                            ...
                            locale={locale} onStepChange={setCurrentStep} ref={questionsRef}/>,
    ...
    },
    {
      ...
      component: <Attachments userToken={userToken} productId={productId} conversationId={conversationId}
                              locale={locale} onStepChange={setCurrentStep} ref={attachmentsRef}/>,
  ...
  return (
    <Stepper steps={stepList} currentStep={currentStep} onStepChange={setCurrentStep} stepperRef={stepList[currentStep].stepperRef}>
